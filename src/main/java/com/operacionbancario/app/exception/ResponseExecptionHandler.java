package com.operacionbancario.app.exception;
...
public class ResponseExecptionHandler extends ResponseEntityExceptionHandler{
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
		...
		ExceptionResponse exceptionResponse = new ExceptionResponse(new Date(), "Validacion fallida :".concat(errores), request.getDescription(false));
